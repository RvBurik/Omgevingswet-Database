-- Testscript voor SP trCorrectDatumAanvraag
SET NOCOUNT ON
...
BEGIN TRY
	...
	DECLARE @DATUMAANVRAAG DATE = '1990-01-01'
...
END TRY
BEGIN CATCH
PRINT 'Test 1 is geslaagd. Foutmelding: De aanvraagdatum kan niet voor de projectdatum liggen!';
	IF (@TRANCOUNT = 0)
		ROLLBACK TRAN
	ELSE
		ROLLBACK TRAN savepoint;
