...
BEGIN
  ...
  BEGIN TRY
    ...
    WHERE GEBRUIKERSNAAM + '|' + CAST(PROJECTID AS VARCHAR) IN (
      SELECT d.GEBRUIKERSNAAM + '|' + CAST(pg.PROJECTID AS VARCHAR) --d.GEBRUIKERSNAAM, pg.PROJECTID, ROLNAAM, AUTOMATISCHTOEGEVOEGD
      ...
      /*SELECT
        GEBRUIKERSNAAM,
        PROJECTID,
        'Belanghebbende' AS ROLNAAM,
        1                AS AUTOMATISCHTOEGEVOEGD*/
